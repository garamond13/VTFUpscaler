...
#define VTFU_FLT_EPS 1e-6

// enum VTFU_KERNEL_FUNCTION_
#define VTFU_KERNEL_FUNCTION_LANCZOS 0
#define VTFU_KERNEL_FUNCTION_GINSENG 1
#define VTFU_KERNEL_FUNCTION_HAMMING 2
#define VTFU_KERNEL_FUNCTION_POW_COSINE 3
#define VTFU_KERNEL_FUNCTION_KAISER 4
#define VTFU_KERNEL_FUNCTION_POW_GARAMOND 5
#define VTFU_KERNEL_FUNCTION_POW_BLACKMAN 6
#define VTFU_KERNEL_FUNCTION_GNW 7
#define VTFU_KERNEL_FUNCTION_SAID 8
#define VTFU_KERNEL_FUNCTION_NEAREST 9
#define VTFU_KERNEL_FUNCTION_LINEAR 10
#define VTFU_KERNEL_FUNCTION_BICUBIC 11
#define VTFU_KERNEL_FUNCTION_MOD_FSR 12
#define VTFU_KERNEL_FUNCTION_BCSPLINE 13

#define is_zero(x) (abs(x) < VTFU_FLT_EPS)
